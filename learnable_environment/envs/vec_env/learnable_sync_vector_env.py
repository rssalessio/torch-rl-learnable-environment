from typing import Callable, List, Tuple, Dict, Union, Optional, Sequence, Any
...
from gym.vector.utils import create_empty_array, concatenate, iterate
...
class LearnableSyncVectorEnv(LearnableVecEnv):
    def __init__(self, env_fns: List[Callable[[], LearnableEnvironment]], copy: bool = True):
        """
        ...
        super(LearnableVecEnv, self).__init__(
